...
zm99 <- read_excel("C:\\Users\\leope\\Documents\\RepTemplates\\ZonasMetro\\Bases de datos\\zm99.xlsx")
zm04 <- read_excel("C:\\Users\\leope\\Documents\\RepTemplates\\ZonasMetro\\Bases de datos\\zm04.xlsx")
zm09 <- read_excel("C:\\Users\\leope\\Documents\\RepTemplates\\ZonasMetro\\Bases de datos\\zm09.xlsx")
zm14 <- read_excel("C:\\Users\\leope\\Documents\\RepTemplates\\ZonasMetro\\Bases de datos\\zm14.xlsx")
...
ui <- fluidPage(
  ...
  selectInput("variables2",
              ...
              choices = names(zm99), names(zm04), names(zm09), names(zm14), names(zm19)
              multiple = TRUE,
              selected = NULL),
