...
zm99 <- read_excel("C:\\Users\\rpm0a\\OneDrive\\Documentos\\RepTemplates\\ZonasMetro\\Bases de datos\\zm99.xlsx")
zm04 <- read_excel("C:\\Users\\rpm0a\\OneDrive\\Documentos\\RepTemplates\\ZonasMetro\\Bases de datos\\zm04.xlsx")
zm09 <- read_excel("C:\\Users\\rpm0a\\OneDrive\\Documentos\\RepTemplates\\ZonasMetro\\Bases de datos\\zm09.xlsx")
zm14 <- read_excel("C:\\Users\\rpm0a\\OneDrive\\Documentos\\RepTemplates\\ZonasMetro\\Bases de datos\\zm14.xlsx")
zm19 <- read_excel("C:\\Users\\rpm0a\\OneDrive\\Documentos\\RepTemplates\\ZonasMetro\\Bases de datos\\zm19.xlsx")

# Leer archivo de variables sociodemográficas
Base_sociodemo <- read_excel("C:\\Users\\rpm0a\\OneDrive\\Documentos\\RepTemplates\\ZonasMetro\\Bases de datos\\Base _sociodemo.xlsx")
...
ui <- fluidPage(
  ...
  selectInput("variables",
              ...
              selected = NULL),
  selectInput("anios",
              "Selecciona el año de las variables económicas:",
              choices = c("1999" = "zm99",
                          "2004" = "zm04",
                          "2009" = "zm09",
                          "2014" = "zm14",
